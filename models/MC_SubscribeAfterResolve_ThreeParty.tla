...
(* tag (target host vatC is neither sender vatB nor listener vatA), but    *)
(* the CASE's OTHER arm fell through to DescImportTarget, silently         *)
(* emitting desc:import-target on the wire.  WireDescriptorContract would  *)
(* have been violated (handoff-give descriptor in a two-party context).    *)
(*                                                                         *)
