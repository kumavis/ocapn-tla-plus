...
SCENARIO_TESTS=(
  ...
  "MC_ShorteningUnsafe_3Chain|violation"
  "MC_EJavaFlush_3Chain|pass"
  "MC_EJavaFlush_3Chain_PromiseShorten|pass"
  "MC_EJavaFlush_3Chain_PromiseShorten_3Party|violation"
  "MC_EJavaFlush_4Chain|pass"
  "MC_OpFlushProtocol_3Chain_PromiseShorten|violation"
  "MC_OpFlushProtocol_3Chain_PromiseShorten_3Party|violation"
  "MC_EJavaFlush_TribbleFourWay|violation"
  "MC_OpFlushProtocol_TribbleFourWay|violation"
  "MC_OpFlushProtocol_4Chain|violation"
