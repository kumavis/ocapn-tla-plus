...
(***************************************************************************)
(* Policy module for `NoPromiseResolution`.                                   *)
(*                                                                         *)
...
----------------------------------------------------------------------------
(* Policy hook implementations: NoPromiseResolution.
   Listeners stay empty; op:resolve never fires; nothing else either. *)
